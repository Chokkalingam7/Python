...
a=int(input("""Enter details for
            1.Doctor
            2.PAtient
            3.Co-Worker
            """))
if(a==1):
    def insert(name,ex,specs):
     res=con.cursor()
...
if(a==2):
    ...
    while True:
     ...
     print("2.Update Data")
     print("3.Select a Data")
     print("4.Delte a Data")
     print("5.Exit")
     ch=int(input("Enter your choice  "))
     if(ch==1):
        ...
        id=int(input("Enter the id of the Patient need to Updated: "))
        name=input("Enter name of te Patient need to Updated: ")
